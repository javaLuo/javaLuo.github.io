...
> ![域名配置](/public/img/taobao/t2.png)<br/>
...
> 对于这个链接参数，猜猜我是怎么得到的。我到天猫APP找了一个别人做好的小程序，分享出来淘口令，又把淘口令拿到网上有那种解析淘口令的网站，解析出来，一个一个试它里面的参数，才发现里面的秘密。<br/>
...
12. 关于\`env\`字段
  ...
  \`\`\`
  > 关于这个\`env\`参数，官方文档的解释是这样的：
![小程序跳转](/public/img/taobao/t3.png)<br/>
...
1.  提交淘宝审核
    ...
    > 我根本不care好吗，审核的时候给我显示出个链接"淘宝设计规范" 你跟我说要符合你们的设计规范，什么边距要多少px，图片要多大，我尼玛你早点说啊，都要上线了，尼玛又不是我设计的，我这会儿还要去找设计师改UI？（还好通过审核了）<br/>
    > 审核的注意事项，这是阿里内部人员给的回复原话：<br/>
    > ![提交审核](/public/img/taobao/t4.png)<br/>
    > 其实根本不用报备，你需要这样做：<br/>
...
2.  云函数发布上线
    > 如果你的项目在双十一期间发布（大概前后半个月吧），哦吼，恭喜你，封网了，云函数不让发线上环境！<br/>
    > 淘宝真的巨恶心，为了保证他们重要的双十一的稳定性，不让其他小程序发版。我这项目就是为了双十一开发的，你不让我发？<br/>
    > 必须到开发者工具去紧急部署申请：<br/>
    ![提交审核](/public/img/taobao/t5.png)<br/>
    > 坑才刚刚开始，这个申请，技术人员说半个小时之内会完成操作，感情阿里你们不是要修福报吗，怎么才7点过就下班了，都没人审，我等了一个通宵我靠。<br/>
    > 迷迷糊糊睡着了，第二天起来一看，还尼玛在“审核中”。<br/>
    > 有同学会问，你直接去睡觉，第二天上班再操作不就好了。问题在于，审核通过后，**只有1个小时的有效期!**这尼玛就很难受了，更关键在于你根本不知道什么时候会审核通过，完全没有通知，好歹给我发个邮件或发个短信啊，什么也没有。<br/>
    > 图中显示“审核已过期”，是他们更新过了，之前过没过期根本不显示，只会显示“审核成功”。都过期了也显示“审核成功”。我向阿里技术人员反映，估计他们才加上的。哎哟，我头好痛。

3.  小程序名称
    > 在开发的时候，显示小程序的LOGO、名称、简介，上线后不允许修改，其实是可以修改的，有图为证：
    ![提交审核](/public/img/taobao/t6.png)
