...
> 淘宝小程序，真是尼玛的坑死了。
> 淘宝的技术人员也是TMB的高高在上拽得不得了。
> 第1句话我理解是：线上请务必改成online，不然流量可能去访问test环境
> 第3句话我理解是：线上环境无论设置成什么，都会自动使用online
> 这两句话不是前后矛盾吗？
...
> 这是怎么回事呢？
> 原因是一个完成的淘宝商家应用需要一个商家端（千牛应用）和一个客户端（小程序）组成。
> 只有这两个东西都正式上线后，才能在上面的图片中点击那个“上线”按钮最终正式上线.
> 但我们的业务不需要商家端应用，只有小程序，咋办呢？
