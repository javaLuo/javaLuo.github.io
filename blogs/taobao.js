...
1. 官方名称叫“淘宝商家应用”
> 在百度搜淘宝小程序连个官网都找不到，也搜不出什么文档链接，必须搜“淘宝商家应用”才出来官网。<br/>
> 但它们文档里又处处都称自己“淘宝小程序”或“手淘小程序”，它们的客服、阿里开发人员都承认这就是“小程序”。这不是多大问题，只是我刚开始开发的时候不懂，网上找文档都找不到，真尼玛醉了。
...
> 想看看示例代码：<br/>
> ![示例](/img/taobao/bb2.png)<br/>
> 没有示例代码！好吧，没有就算了，猜也能猜到该怎么用，可是：<br/>
> ![示例](/img/taobao/bb3.png)<br/>
> 真机调试，根本就没有这个API!??(我开发者工具和手机淘宝APP都是最新版本)。<br/>
> 我们可以看到淘宝后台可以设置小程序的最低版本库，最新的是1.24.8<br/>
> 但当用户出现问题给我们留言时，查看用户的基础库版本：<br/>
> ![示例](/img/taobao/bb7.png)<br/>
> 用户的版本都这么高的吗？ 官方最新版本是1.24.8，用户直接9.x了，我靠，完全对不上呀？这怎么设置？惊了
